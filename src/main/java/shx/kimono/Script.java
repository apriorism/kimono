...
public class Script {
    ...
    public void load() {
        ...
        try {
            ...
            Kimono.getPlugin().getLogger().info("Script " + getCompiledClass() + " does not have a load method!");
        }
    }
    ...
    public void unload() {
        ...
        try {
            ...
            Kimono.getPlugin().getLogger().info("Script " + getCompiledClass() + " does not have an unload method!");
        }
    }
        ...
        if (instance == null) {
            try {
                try {
                    ...
                    instance = constructor.newInstance(Kimono.getPlugin());
                } catch (NoSuchMethodException e) {
                    Kimono.getPlugin().getLogger().info("No plugin constructor! Using default constructor...");
